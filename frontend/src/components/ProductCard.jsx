import { Box, Heading,Text,IconButton,HStack, useColorModeValue,Image, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, VStack,Input, ModalFooter, Button } from "@chakra-ui/react";
    ...
    shadow='lg'
        ...
        <Box p={4}>
          ...
          <HStack spacing={2}>
           ...
           colorScheme='blue' />
					<IconButton
						icon={<DeleteIcon />} onClick={()=> handleDeleteProduct(product._id)}
						colorScheme='red'
					/>
				</HStack>
        </Box>
